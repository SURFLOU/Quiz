...
void SetAllValues()
{
	...
	q[92].setValues("Ktore z ponizszych zdan nie charakteryzuje naglowka w dokumencie tekstowym?",
		...
		'c');
	q[93].setValues("Ktore z ponizszych zdan nie charakteryzuje tabulcji w edytorze tekstu?",
		"Tabulacja to mechanizm wbudowany w edytor tekstu, pozwalajacy wplywac na polozenie fragmentu tekstu w wierszu.",
	...
	q[138].setValues("Ktore z ponizszych nie jest protokolem internetowym?",
		...
		"HTML",
		'd');
	q[139].setValues("Operator przypisania to operator, ktory:",
		"powoduje, ze zmienna zostanie przeniesiona na dysk",
		"przypisuje zmiennej wartosc",
		"powoduje wykonanie petli w programie",
		"przypisuje zmiennej nazwe",
		'b');
	q[140].setValues("MBR (Master Boot Record) to: ",
		"Struktura zapisana w pierwszym sektorze dysku twardego m.in. zawierajaca program rozruchowy",
		"Glowny proces w systemie operacyjnym",
		"Glowny kontroler pamieci masowej ",
		"Glowny sterownik pamieci operacyjnej na plycie glownej komputera",
		'a');
	q[141].setValues("Gdzie powstal pierwszy graficzny interfejs uzytkownika?",
		"W laboratoriach firmy Apple",
		"W firmie Microsoft",
		"W laboratorium PARC firmy Xerox",
		"W laboratoriach firmy Samsung",
		'c');
	q[142].setValues("Ktore z ponizszych jest protokolem internetowym?",
		"CSS",
		"HTTP",
		"HTML",
		"XML",
		'b');
	q[143].setValues("Jakiej pamieci nie znajdziemy w systemie komputerowym:",
		"pamieci operacyjnej",
		"pamieci nieulotnej",
		"pamieci absolutnej",
		"pamieci masowej",
		'c');
	q[144].setValues("Co otrzymamy po wykonaniu ponizszego pseudokodu:\n1.Pobierz pierwszy element tablicy i podstaw go pod x.\n2.Pobierz nastepny element tablicy.\n3.Jezeli nastepny element tablicy jest mniejszy niz x, podstaw jego wartosc za x.\n4.Jezeli nie ma wiecej elementow w tablicy zakoncz, w przeciwnym przypadku wroc do punktu 2.",
		"wartosc minimalna elementow tablicy",
		"wartosc srednia elementow tablicy",
		"liczbe elementow tablicy",
		"wartosc maksymalna elementow tablicy",
		'a');
	q[145].setValues("Ktore z ponizszych zdan jest prawdziwe?",
		"kompresja stratna i bezstratna to to samo",
		"kompresja stratna nie sluzy do redukcji liczby bitow potrzebnych do reprezentacji grafiki lub dzwieku",
		"kompresja bezstratna gwarantuje odtworzenie pierwotnej jakosci grafiki lub dzwieku",
		"istnieje jeden uniwersalny algorytm kompresji stratne",
		'c');
	q[146].setValues("Klaster komputerowy to:",
		"Program komputerowy pozwalajacy podzielic dane na klasy",
		"Komputer posiadajacy wysokiej klasy oprogramowanie",
		"Program komputerowy do zarzadzania zbiorami filatelistycznymi i numizmatycznymi",
		"Grupa polaczonych jednostek komputerowych, ktore wspolpracuja ze soba",
		'd');
	q[147].setValues("Ktory z ponizszych znacznikow jest poprawnym hiperlaczem do strony 'www.bialystok.pl'?",
		"<A HREF='http://www.bialystok.pl/' (tez poprawna jakby co, 2 sie nie dalo)>",
		"<A HREF='www.bialystok.pl'>",
		"<A SRC='http://www.bialystok.pl/'>",
		"<A SRC='www.bialystok.pl'>",
		'b');
	q[148].setValues("W systemie plikow nie wystepuje:",
		"teczka",
		"plik",
		"katalog",
		"folder",
		'a');
	q[149].setValues("W schemacie blokowym blok wejscia-wyjscia sluzy do:",
		"wprowadzania danych wejsciowych i do wyprowadzania wynikow",
		"rozpoczecia algorytmu",
		"blokowania wejscia i wyjscia",
		"okreslania warunku",
		'a');
	q[150].setValues("Kto jest uwazany za tworce WWW (World Wide Web)?",
		"Linus Torvalds",
		"Steve Jobs",
		"Tim Berners-Lee",
		"Bill Gates",
		'c');
	q[151].setValues("Model przestrzeni barw uwzgledniajacy mieszanie trzech trzech wiazek swiatla (czerwonej, zielonej, niebieskiej) to: ",
		"CMYK",
		"HSL",
		"RGB",
		"HSV",
		'c');
	q[152].setValues("Polecenie ping sluzy do:",
		"przeslania pliku z wykorzystaniem protokolu ping",
		"sprawdzenia polaczenia z podanym adresem internetowym",
		"wyznaczania trasy alternatywnej",
		"odnalezienia urzadzen obslugujacych protokol ping",
		'b');
	q[153].setValues("in(k,z);while(k!=z){if(k>z)do(k=k-z);else(z=z-k);}out(k)",
		"Algorytm obliczania sumy",
		"Algorytm wyznaczania najwiekszego wspolnego dzielnika",
		"Algorytm wyznaczania roznic",
		"Algorytm wyznaczania wiekszej liczby",
		'b');
	q[154].setValues("Miara wydajnosci jednostki centralnej CPU komputera, ktora okresla liczbe milionow operacji\nstaloprzecinkowych wykonywanych w ciagu sekundy to:",
		"GHz",
		"MIPS",
		"FLOPS",
		"bps",
		'b');
	q[155].setValues("Protokol IP wersji 6:",
		"nie ma jeszcze tej wersji protokolu - moze bedzie w przyszlosci",
		"jest poprzednikiem stosowanego obecnie IP wersji 8",
		"pozwala na wyjatkowo szybka transmisje dzwieku w telefonach komorkowych (i tylko dzwieku)",
		"pozwala zaadresowac znacznie wieksza liczbe urzadzen niz IP w wersji 4",
		'd');
	q[156].setValues("Na ponizszym rysunku przedstawiono schemat blokowy algorytmu obliczania funkcji silnia (n!), gdzie\nn! = 1 · 2 · 3 · ... · (n-1) · n (silnia jest to iloczyn kolejnych liczb naturalnych mniejszych badz rownych\nn). Co powinno byc wpisane w pusty element schematu?",
		"dobra odp",
		"zla odp",
		"dobra odp to a",
		"zadanie bylo proste nie chcialo mi sie go pisac",
		'a');
	q[157].setValues("Siec komputerowa oparta o standard Bluetooth (802.15) to siec:",
		"LAN",
		"SAN",
		"PAN",
		"MAN",
		'c');
	q[158].setValues("Jedno slowo to 2 bajty. Ile slow miesci sie w kibibajcie?",
		"512",
		"1000",
		"500",
		"1024",
		'a');
	q[159].setValues("Interfejsem do podlaczania dysku twardego nie jest: ",
		"DVI",
		"mSATA",
		"SATA",
		"PCIe",
		'a');
	q[160].setValues("Ktory z ponizszych zapisow przedstawia poprawny znacznik HTML?",
		"[BODY]",
		"<BODY>",
		"{BODY}",
		"(BODY}",
		'b');
	q[161].setValues("ENIAC - jeden z pierwszych komputerow elektronicznych wykorzystywal jak elementy czynne: ",
		"lampy elektronowe",
		"uklady scalone",
		"zarowki",
		"tranzystory",
		'a');
	q[162].setValues("(arkusz excela)\n\tA\n1\t1\n2\t2\n3\t3\n4\t4\n5\nJaka bedzie zawartosc komorki A5 po wpisaniu formuly:\n=SUMA(A1:A1:A2:A2:A3:A3:A4:A4)",
		"10",
		"blad",
		"20",
		"0",
		'a');
	q[163].setValues("Jezyk programowania to:",
		"zbior slow, ktore moze wypowiedziec komputer",
		"nieusystematyzowany sposob przekazywania komputerowi polecen do wykonania",
		"analiza i modelowanie obiektow i ukladow roznej natury",
		"usystematyzowany sposob przekazywania komputerowi polecen do wykonania",
		'd');
	q[164].setValues("Ktory z ponizszych interfejsow video nie jest interfejsem cyfrowym?",
		"HDMI",
		"Display Port",
		"DVI",
		"D-SUB (VGA)",
		'd');
	q[165].setValues("Algorytm babelkowy sortowania:",
		"jest dosc wolny, ale prosty do napisania",
		"dziala tylko na liczbach calkowitych",
		"jest jednym z szybszych algorytmow sortowania",
		"nie zawsze zapewnia poprawne sortowanie (ale przewaznie dziala dobrze)",
		'a');
	q[166].setValues("Tworca jezyka C to:",
		"Steve Jobs",
		"Dennis Ritchie",
		"Bill Gates",
		"Ken Thompson(tworca unixa i jezyka B)",
		'b');
	q[167].setValues("Symbol 'F2' mozna spotkac w wielu sytuacjach zwiazanych z informatyka. W ktorym z ponizszych\nprzypadkow z nim sie nie spotkamy:",
		"adres urzadzenia w sieci IPv4",
		"wartosc liczby w systemie szesnastkowym",
		"symbol klawisza funkcyjnego",
		"adres komorki w arkuszu",
		'a');
	q[168].setValues("<table>\n <tr>\n <th>1</th> \n<th>2</th>\n <th>3</th>\n </tr>\n <tr>\n <td>1</td>\n <td>2</td> \n<td>3</td> \n</tr> \n</table>\n Powyzszy kod w jezyku HTML stworzy tabele skladajaca sie z : ",
		"3 wierszy i 3 kolumn",
		"3 wierszy i 2 kolumn",
		"2 wierszy i 2 kolumn ",
		"2 wierszy i 3 kolumn",
		'd');
	q[169].setValues("Ktory z przedstawionych ponizej jest poprawnym znacznikiem jezyka HTML?",
		"[HTML]",
		"(HTML)",
		"{HTML}",
		"<HTML> ",
		'd');
	q[170].setValues("Co zwraca formula =FRAGMENT.TEKSTU(B14;3;2) w arkuszu kalkulacyjnym?",
		"dodaje 2 znaki z tekstu znajdujacego sie w komorce B14, zaczynajac od 3 znaku ",
		"zwraca 2 znaki z tekstu znajdujacego sie w komorce B14, zaczynajac od 3 znaku ",
		"usuwa 2 znaki z tekstu znajdujacego sie w komorce B14, zaczynajac od 3 znaku ",
		"zwraca 3 znaki z tekstu znajdujacego sie w komorce B14, zaczynajac od 2 znaku ",
		'b');
	q[171].setValues("W jaki sposob w dokumencie HTML tworzy sie znaczniki zamykajace?",
		"za pomoca slowa kluczowego END",
		"poprzez dodanie znaku wykrzyknika (!) po nazwie znacznika",
		"poprzez dodanie znaku wykrzyknika (!) przed nazwa znacznika",
		"poprzez dodanie znaku ukosnika (/) przed nazwa znacznika",
		'd');
	q[172].setValues("Co to jest kontener multimedialny? ",
		"rodzaj systemu operacyjnego do tworzenia multimediow",
		"program sluzacy do kodowania plikow audio lub video ",
		"format pliku komputerowego uzywanego do przechowywania danych takich jak sygnal m.in.audio lub video",
		"urzadzenie sluzace do przechowywania plikow audio/video",
		'c');
	q[173].setValues("Ktory z ponizszych kodow dwojkowych umozliwia zapis liczby calkowitej ze znakiem ?",
		"kod uzupelnien do 2",
		"kod Johnsona ",
		"kod Graya ",
		"naturalny kod binarny",
		'a');
	q[174].setValues("Ktore z ponizszych nie jest konieczne przy konfiguracji karty sieciowej, aby moc polaczyc sie z Internetem ? ",
		"maska podsieci",
		"adres IP komputera",
		"adres MAC",
		"adres bramy domyslnej ",
		'c');
	q[175].setValues("Palmtop to:",
		"miniaturowy komputer mieszczacy sie w dloni",
		"komputer w obudowie wykonanej z drewna palmowego",
		"komputer umozliwiajacy ogladanie telewizji w standardzie nadawania PAL",
		"jeden z typow dotykowych paneli sterujacych (rodzaj touchpad'a)",
		'a');
	q[176].setValues("Ktora z ponizszych aplikacji sluzy do odtwarzania plikow multimedialnych?",
		"AVR",
		"MMC",
		"VOB",
		"VLC",
		'd');
	q[177].setValues("Komputer ma przypisany adres IPv4 postaci 192.168.63.2 z maska podsieci 255.255.255.240.Ktory z ponizszych adresow bedzie poprawnym adresem bramy domyslnej dla tego komputera ? ",
		"192.168.0.1",
		"192.168.64.1",
		"192.168.63.2",
		"192.168.63.1",
		'd');
	q[178].setValues("Z jaka organizacja zwiazane jest powstanie sieci WWW wraz z jego tworca sir Timothy Berners - Lee ? ",
		"Naukowa i Akademicka Siecia Komputerowa NASK",
		"Instytutem Technologicznym w Massachusetts MIT",
		"Instytutem Inzynierow Elektrykow i Elektronikow IEEE",
		"Europejska Organizacja Badan Jadrowych CERN",
		'd');
	q[179].setValues("Ktora z ponizszych konstrukcji jezyka HTML pozwoli wstawic obrazek?",
		"<src img='pies.jpg' alt='Piesek'>",
		"<img file='pies.jpg' alt='Piesek'>",
		"<img src='pies.jpg' alt='Piesek'>",
		"<img img='pies.jpg' alt='Piesek'> ",
		'c');
	q[180].setValues("Ktory z ponizszych algorytmow nie jest algorytmem sortowania?",
		"sortowanie babelkowe",
		"sortowanie kubelkowe",
		"sortowanie pudelkowe",
		"sortowanie przez wstawianie",
		'c');
	q[181].setValues("Klaster komputerowy to:",
		"inaczej klasyczny komputer PC ",
		"program komputerowy pozwalajacy podzielic dane na klasy",
		"komputer posiadajacy wysokiej klasy oprogramowani",
		"grupa polaczonych jednostek komputerowych, ktore wspolpracuja ze soba",
		'd');
	q[182].setValues("System operacyjny to:",
		"program komputerowy, ktory wykonuje rozmaite operacje na danych uzytkownika ",
		"podstawowy element na plycie glownej komputera",
		"oprogramowanie, ktore zarzadza udostepnianiem zasobow komputera aplikacjom ",
		"program komputerowy wspomagajacy lekarzy przy wykonywaniu operacji chirurgicznych ",
		'c');
	q[183].setValues("Ktore znaczniki HTML okreslaja strukture dokumentu definiujac naglowek i cialo dokumentu ? ",
		"H1 i P",
		"HEADER i SECTION",
		"HTML i TEXT",
		"HEAD i BODY ",
		'd');
	q[184].setValues("Jeden lub wiecej wierszy tekstu stanowiacych calosc logiczna, zakonczony znakiem nowego wiersza('enter') to: ",
		"strona",
		"akapit",
		"rozdzial",
		"sekcja",
		'b');
	q[185].setValues("Pewien tekst zaszyfrowano za pomoca znanego szyfru podstawieniowego. Wiadomo, ze trzecia i dziewiata litera tekstu oryginalnego to 'A'.Tresc szyfrogramu to : XUJSNUXMJ.Jaki jest tekst oryginalny(zakladajac, ze uzyto alfabetu lacinskiego) ? ",
		"OLAJELODA",
		"ALAMALODA",
		"ALAMAKOTA",
		"OLAMAKOTA",
		'a');
	q[186].setValues("Wartosc liczby zapisanej w systemie szesnastkowym A6B(16) wynosi: ",
		"101001101011(2)",
		"41652(6)",
		"2668(10)",
		"5154(8)",
		'a');
	q[187].setValues("Nazwa modem wywodzi sie z dwoch slow angielskich zwiazanych z procesem komunikacji.Jakie to slowa ? ",
		"coding i decoding",
		"modulation i demodulation",
		"modern maniacs ",
		"molecule deminimizing",
		'b');
	q[188].setValues("Ktore z ponizszych stwierdzen nie opisuje systemu nazw domenowych DNS?",
		"DNS pozwala na zamiane nazwy domenowej na adres IP",
		".fm to domena najwyzszego poziomu nie przypisana zadnemu panstwu, lecz wylacznie stacjom radiowym ",
		".pl to domena najwyzszego poziomu przypisana do Polski",
		"DNS pozwala na zamiane adresu IP na nazwe domenowa",
		'b');
