...
void SetAllValues()
{
    ...
    q[104].setValues("Ktora z ponizszych nazw jest nazwa edytora tekstu?",
        ...
        "Funkcje LICZ.PUSTE",
        'c');
    q[105].setValues("Jedno slowo to 2 bajty. Ile slow miesci sie w kilobajcie? ",
        "512 ",
        "500",
        "1000 ",
        "1024",
        'a');
    q[106].setValues("W arkuszu kalkulacyjnym nastepna kolumna po kolumnie Z ma symbol: ",
        "A",
        "Z1",
        "AA",
        "END",
        'c');
    q[107].setValues("Jaki wynik otrzymamy po wpisaniu do komorki arkusza kalkulacyjnego nastepujacej formuly: =JEZELI(LUB(1+1=3;2+2=4);5;10)",
        "4",
        "3",
        "5",
        "10",
        'c');
    q[108].setValues("0xFF w systemie szesnastkowym to w systemie dwojkowym: ",
        "1",
        "0xFF",
        "255",
        "11111111",
        'd');
    q[109].setValues("Algorytm to",
        ...
        'c');
    q[110].setValues("W pamieciach przenosnych USB oraz kartach pamieci stosowana jest pamiec",
        "FLASH ",
        "ROM",
        "RAM",
        "EPROM",
        'a');
    q[111].setValues("Jezeli zlozonosc obliczeniowa sortowania babelkowego jest kwadratowa, to: ",
        ...
        'a');
    q[112].setValues("Standard IEEE 802.15 to powszechnie znany standard: ",
        "Ethernet",
        "Bluetooth",
        "WiMAX",
        "WLAN (inaczej wifi)",
        'b');
    q[113].setValues("Interfejsem do podlaczania dysku twardego nie jest",
        "RS-232C",
        "SCSI ",
        "SATA",
        "ATA ",
        'a');
    q[114].setValues("Wybierz prawidlowe wywolanie funkcji LICZ.JEZELI:",
        "=LICZ.JEZELI(B2:B16;”<>konkurs”) ",
        "=LICZ.JEZELI(A3:A8,”<>konkurs”)",
        "LICZ.JEZELI(C1:C4;”konkurs or test”) ",
        "=LICZ.JEZELI(D5:D59,”konkurs or test”)",
        'a');
    q[115].setValues("Interfejs USB w komputerze",
        ...
        'd');
    q[116].setValues("Superkomputer to:",
    ...
    q[119].setValues("Co otrzymamy po wykonaniu ponizszego pseudokodu: \n1.Pobierz pierwszy element tablicy i podstaw go pod x.\n2.Pobierz nastepny element tablicy.\n3.Jezeli nastepny element tablicy jest wiekszy niz x, podstaw jego wartosc za x.\n4.Jezeli nie ma wiecej elementow w tablicy zakoncz, w przeciwnym przypadku wroc do punktu 2.",
        ...
        'b');
    q[120].setValues("Do poprawnej konfiguracji polaczenia w sieciach IPv4 nie jest konieczne:",
        "adres IP bramy domyslnej",
        "adres IP urzadzenia ",
        "dlugosc przewodu UTP",
        "maska podsieci",
        'c');
    q[121].setValues("Ktory z algorytmow nie sluzy do kompresji dzwieku?",
        "MP3",
        "MPEG-4",
        "Vorbis ",
        "Windows Media Audio",
        'b');
    q[122].setValues("Suma kontrolna, np. pliku, umozliwia: ",
        ...
        'b');
    q[123].setValues("Dyskowym systemem plikow nie jest:",
        "FAT32",
        "EPROM",
        "NTFS",
        "FAT16",
        'b');
    q[124].setValues("Liczba zmiennoprzecinkowa w informatyce to format w ktorym mozna zapisac:",
    ...
    q[125].setValues("Chipset to: ",
        ...
        'b');
    q[126].setValues("Liczba w systemie szesnastkowym EF45(16) przedstawiona w systemie osemkowym ma postac:",
        "167515",
        "167505",
        "8745",
        "8744",
        'b');
    q[127].setValues("Obraz z cyfrowego aparatu fotograficznego jest zapisywany w postaci",
        "mapy",
        "grafiki wektorowej",
        "grafiki rastrowej",
        "piksela",
        'c');
    q[128].setValues("Co to jest CAPTCHA?",
        "edytor tekstu",
        "rodzaj robaka",
        "rodzaj robota internetowego",
        "technika sprawdzania, czy formularz wypelnia czlowiek, czy robot ",
        'd');
    q[129].setValues("W adresacji IPv4 adres sklada sie z:",
        "4 liczb szesnastkowych",
        "48 bitow",
        "32 bitow ",
        "32 oktetow ",
        'c');
    q[130].setValues("System liczbowy siedemnastkowy: ",
    ...
    q[131].setValues("Bluetooth to",
        ...
        'b');
    q[132].setValues("Wybierz zdanie prawdziwe dotyczace kompresji danych: ",
        ...
        'c');
    q[133].setValues("Ile liczb pieciocyfrowych mozna uzyskac uzywajac wszystkich cyfr: 1, 2, 3, 4, 5?",
        "3125",
        "120",
        "200",
        "5",
        'a');
    q[134].setValues("Ktore z ponizszych zdan nie jest prawdziwe?",
        ...
        'a');
    q[135].setValues("Liczbe 101111111101 (system dwojkowy) zapisana w systemie szesnastkowym przedstawia:",
        "151612",
        "876",
        "ADC",
        "BFD ",
        'd');
    q[136].setValues("Adresacja bezwzgledna w arkuszach kalkulacyjnych",
